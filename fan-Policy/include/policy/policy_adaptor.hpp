...
class policy_adaptor : public ::DBus::InterfaceAdaptor {
public:
  policy_adaptor()
  ...
  ::DBus::IntrospectedInterface *introspect() const {
    ...
    static ::DBus::IntrospectedMethod policy_adaptor_methods[] = {
        ...
        {0, 0}};
    static ::DBus::IntrospectedMethod policy_adaptor_signals[] = {{0, 0}};
    static ::DBus::IntrospectedProperty policy_adaptor_properties[] = {
        {0, 0, 0, 0}};
    static ::DBus::IntrospectedInterface policy_adaptor_interface = {
        "org.freedesktop.keti.bmc.policy", policy_adaptor_methods,
        policy_adaptor_signals, policy_adaptor_properties};
...
private:
  /* unmarshalers (to unpack the DBus message before calling the actual
   * interface method)
   */
