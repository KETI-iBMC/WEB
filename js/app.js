...
app.config(['$translateProvider', function ($translateProvider) {
    ...
    $routeProvider
        ...
        */
        ...
        .when('/faultAnalysisOverallMonitoing', {
            templateUrl: 'views/faultAnalysisOverallMonitoing.html',
            controller: 'MaintenanceBmcResetController'
        })
        ...
        .when('/energySaving', {
            ...
            controller: 'EnergySavingSmartFanControlController'
        })
    ...
    return {
        ...
        FAULT_ANALYSIS: {
            ...
            FOFL_POLICY: domain + '/foflPolicy',
            DISK_REPORT: domain + '/diskReport',
            LOG_MONOTIRING: domain + '/logMonitoring'
        },
        ENERGY_SAVING: {
            SMART_FAN_CONTROL: domain + '/smartFanControl',
            CPU_POWER_CAPPING: domain + '/cpuPoweraCpping',
        },
        SETTINGS: {
