...
;(function (factory) {
    ...
    Indicator.prototype = {
        ...
        _init: function() {
            ...
            //maximum text length;
            this.maxLength = indOption.celsius ? 4 : this.formatter(indOption.maxValue).length;
        ...
        value: function(val) {
            ...
            var precision = indOption.precision != null ? indOption.precision : 0,
                ...
                dispVal = indOption.celsius ? perVal + '°C' : this.formatter(val); //formatted value
            ...
            // var gradient = ctx.createLinearGradient(0, 0, dim / 2, 0);
        ...
        animate: function(val) {
            var indOption = this.indOption,
                ...
                minVal = indOption.minValue,
                maxVal = indOption.maxValue,
                frameNum = indOption.frameNum || (indOption.celsius ? 100 : 500),
        ...
        option: function(key, val) {
            ...
            if (['radius', 'barWidth', 'barBgColor', 'format', 'maxValue', 'celsius'].indexOf(key) != -1) {
    ...
    radialIndicator.defaults = {
        radius: 34, //40, //inner radius of indicator
        ...
        celsius: true, //show percentage of value
