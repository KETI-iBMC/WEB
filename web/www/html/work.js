...
var _AST = { mode: 420,pixels_per_block: 8,MB: 4096,mb_width: 0,mb_height: 0,Y_Sel: 4,UV_Sel: 20,
...
function doMouseDown(e) { if(mouseEnable===1){
	drag_state = 1;
	var send_buf = new Uint8Array(15);
...
function doMouseUp(e) { if(mouseEnable===1){
	drag_state = 0;
	var send_buf = new Uint8Array(15);
	var e = e || window.event;
	var btnCode;
...
function doMouseDrag(e) { if(mouseEnable===1){
	if (drag_state) {
		var send_buf = new Uint8Array(15);
		var e = e || window.event;
		var btnCode;
